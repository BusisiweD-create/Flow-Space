                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        description,
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.white.withAlpha(180)),
                      ),
                    ],
                  ),
                ),
                Icon(Icons.arrow_forward_ios, size: 16, color: Colors.white.withAlpha(180)),
              ],
            ),
          ),
        ),
