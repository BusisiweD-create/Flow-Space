...
class PermissionManager {
  static const Map<String, Permission> _permissions = {
    ...
    'view_sprints': Permission(
      ...
      allowedRoles: [UserRole.teamMember, UserRole.deliveryLead, UserRole.client, UserRole.clientReviewer, UserRole.systemAdmin, UserRole.projectManager, UserRole.scrumMaster],
    ),
